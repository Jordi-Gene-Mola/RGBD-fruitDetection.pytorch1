...
from datasets.kinect_fruits2 import kinect_fruits
...
# Set up kinect_fruits
for split in ['all', 'test', 'train', 'train_val', 'val', 'test_k', 'train_k', 'val_k']:
  name = split
  __sets[name] = (lambda split=split: kinect_fruits(split))
