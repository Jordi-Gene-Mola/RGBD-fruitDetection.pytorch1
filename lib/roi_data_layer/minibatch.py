...
import pdb
def get_minibatch(roidb, num_classes, RGB, NIR, DEPTH):
  ...
  im_blob, im_scales = _get_image_blob(roidb, random_scale_inds, RGB, NIR, DEPTH)
  ...
  for i in range(num_images):
    ...
    if RGB:
      ...
      if NIR|DEPTH:
        ...
        I_D = scipy.io.loadmat(roidb[i]['image'][:87] + '_intensity_depth.mat')
        if NIR:
