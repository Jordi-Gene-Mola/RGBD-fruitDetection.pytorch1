...
#__C.PIXEL_MEANS = np.array([[[102.9801, 115.9465, 122.7717, 5124.937, 1.6897]]])
__C.PIXEL_MEANS = np.array([[[102.9801, 115.9465, 122.7717, 108.4342, 40.5117]]])
...
#__C.DATA_DIR = osp.join('/','work','jgene','faster_rcnn','data')
__C.DATA_DIR = osp.join('/','mnt','gpid08','users','jordi.gene','faster_rcnn','data')
...
__C.MAX_NUM_GT_BOXES = 100 #20

# Anchor scales for RPN
__C.ANCHOR_SCALES = [8,16,32,64] #[8,16,32]
